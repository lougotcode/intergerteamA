            ...
            <div class="row wow bounceIn" data-wow-delay="0.5s" data-wow-duration="2s" id="drugheading">
              ...
              <div class="row wow bounceInLeft" data-wow-delay="0.5s" data-wow-duration="2s">
                <form class="form" action="" method="post">
                  <div class="col-md-2" ><a href="index.php?view" id="viewall" class="btn btn-primary">View All Drugs</a></div>
                  <div class="col-md-8">
                  ...
                  <div class="col-md-2 wow bounceInRight" data-wow-delay="0.7s" data-wow-duration="2s">
                    <input type="submit" name="submit" value="Search" class="btn btn-success id=searchbtn form-control"></div>
                </form>
              </div>
            </div>
        <?php
          ...
          $sql = "SELECT * FROM drug WHERE name LIKE  '$search%'";
            ...
            <div class="row" >
              ...
              <div class="col-md-6 col-sm-6">
                <table id="example" class="table table-condensed table-striped dt-responsive" style="margin:20px">
                  <thead>
        ...
        <?php }elseif (isset($_GET['view'])) {
              $sql2= $conn->query("SELECT * FROM drug"); ?>
                <div class="row">
                  <div class="col-md-3 col-sm-3"></div>
                  <div class="col-md-6 col-sm-6">
              <table id="example" class="table table-condensed table-striped dt-responsive nowrap">
                <thead>
